...
import excelSheetReadng.CommanExcelMethod;
import scrolling_Study.ScrollingFunction;
...
System.setProperty("webdriver.chrome.driver", "D:\\selenium\\chromedriver.exe");
		...
		//Sending username
		driver.findElement(By.id("userCode")).sendKeys(CommanExcelMethod.readDataFromExcel(0, 0));
		
		
		//sending paasword
		driver.findElement(By.name("password")).sendKeys(CommanExcelMethod.readDataFromExcel(0, 1));
		...
		//entering to the DOB
		driver.findElement(By.name("yob")).sendKeys(CommanExcelMethod.readDataFromExcel(0, 2));
